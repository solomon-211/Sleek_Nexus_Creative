...
const PAGES = [
  ...
  { icon: 'fa-diagram-project', label: 'Projects', hint: 'Portfolio & case studies', to: '/projects' },
  { icon: 'fa-bolt', label: 'Innovation Hub', hint: 'Vision 2040 & SDG roadmap', to: '/innovation-hub' },
