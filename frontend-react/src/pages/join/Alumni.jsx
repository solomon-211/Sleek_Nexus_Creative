...
const DEMO_MEMBERS = [
  { _id:'1',  firstName:'Akot',    lastName:'Deng Ayuen',   currentRole:'Frontend Developer',          company:'Equity Bank South Sudan',     location:'Juba, South Sudan',            course:'Web Development Fundamentals',     graduationYear:2020, skills:['HTML','CSS','JavaScript','React'],           bio:'After 12 weeks at SNC I landed my first dev role. Now building the bank\'s internal dashboard used by 200+ staff daily.', linkedin:'#' },
  { _id:'2',  firstName:'Awak',    lastName:'Garang Dut',   currentRole:'UI/UX Designer',              company:'Afrotech Solutions',           location:'Juba, South Sudan',            course:'UI/UX Design',                     graduationYear:2021, skills:['Figma','User Research','Prototyping','Wireframing'], bio:'Switched from marketing to design through SNC. Now designing apps for 3 clients across East Africa.', linkedin:'#', portfolio:'#' },
  { _id:'3',  firstName:'Marial',  lastName:'Wol Kuol',     currentRole:'Android Developer',           company:'Freelance',                    location:'Juba, South Sudan',            course:'Mobile App Development',           graduationYear:2021, skills:['Flutter','Firebase','Android','REST APIs'],   bio:'My capstone app — a market price tracker for Juba traders — now has 400+ active users. Built it in week 8.', github:'#', portfolio:'#' },
  { _id:'4',  firstName:'Achol',   lastName:'Majok Nhial',  currentRole:'Data Analyst',                company:'UNHCR South Sudan',            location:'Juba, South Sudan',            course:'Data Analysis',                    graduationYear:2022, skills:['Python','SQL','Power BI','Excel'],           bio:'Used data skills to improve beneficiary tracking for a 50,000-person program. The reports I now build save my team 2 days a week.', linkedin:'#' },
  { _id:'5',  firstName:'Deng',    lastName:'Atem Garang',  currentRole:'Full-Stack Engineer',         company:'Starlite Technologies',        location:'Juba, South Sudan',            course:'Full-Stack Web Development Bootcamp', graduationYear:2022, skills:['React','Node.js','MongoDB','Express'],    bio:'Was unemployed for 18 months before SNC. Six months after graduating I\'m building enterprise software. Best investment I made.', linkedin:'#', github:'#' },
  { _id:'6',  firstName:'Nyakim',  lastName:'Dau Bol',      currentRole:'Digital Marketing Manager',   company:'Horizon Media Agency',         location:'Juba, South Sudan',            course:'Digital Marketing',                graduationYear:2022, skills:['Social Media','SEO','Google Ads','Analytics'], bio:'Grew a client\'s social media from 200 to 15,000 followers in 6 months using what I learned at SNC.', linkedin:'#' },
  { _id:'7',  firstName:'Lual',    lastName:'Chol Deng',    currentRole:'Cybersecurity Analyst',       company:'National Revenue Authority SS', location:'Juba, South Sudan',            course:'Cybersecurity Basics',             graduationYear:2023, skills:['Network Security','Linux','Firewalls','SIEM'], bio:'Protecting government revenue systems from cyber threats. My first audit found 12 critical vulnerabilities that were quietly fixed.', linkedin:'#' },
  { _id:'8',  firstName:'Ayen',    lastName:'Garang Matur', currentRole:'Software Developer',          company:'Ministry of Health IT Dept.',  location:'Juba, South Sudan',            course:'Full-Stack Web Development Bootcamp', graduationYear:2023, skills:['PHP','Laravel','MySQL','JavaScript'],     bio:'Building health management systems for county hospitals. My team\'s app tracks 8,000+ patient records across 3 facilities.', linkedin:'#' },
  { _id:'9',  firstName:'Garang',  lastName:'Kuei Jok',     currentRole:'Mobile App Developer',        company:'AgriConnect South Sudan',      location:'Wau, Western Bahr el Ghazal',  course:'Mobile App Development',           graduationYear:2023, skills:['React Native','Firebase','TypeScript','Offline-first'], bio:'Built a crop price app for farmers in Wau. Offline-first so it works without internet. Over 800 downloads in 3 months.', github:'#', portfolio:'#' },
  { _id:'10', firstName:'Abuk',    lastName:'Thiik Deng',   currentRole:'UX Researcher',               company:'International Rescue Committee',location:'Juba, South Sudan',            course:'UI/UX Design',                     graduationYear:2023, skills:['User Research','Usability Testing','Figma','Accessibility'], bio:'Research I conducted for IRC improved digital registration tools used by 12,000 displaced persons. Design matters in humanitarian work.', linkedin:'#' },
  { _id:'11', firstName:'Maker',   lastName:'Ring Deng',    currentRole:'Backend Engineer',            company:'Savannah Digital',             location:'Kampala, Uganda',              course:'Full-Stack Web Development Bootcamp', graduationYear:2024, skills:['Node.js','PostgreSQL','Docker','AWS'],      bio:'Moved to Kampala after graduating and got hired in 3 weeks. The portfolio projects I built at SNC got me every interview.', linkedin:'#', github:'#' },
  { _id:'12', firstName:'Ajok',    lastName:'Manyang Thiik',currentRole:'Startup Founder',             company:'EduBridge South Sudan',        location:'Juba, South Sudan',            course:'Web Development Fundamentals',     graduationYear:2024, skills:['React','Node.js','Product Management','Lean Startup'], bio:'Co-founded an edtech startup connecting students to tutors across Juba. 120 active users after 2 months. None of this was possible before SNC.', portfolio:'#', linkedin:'#' },
]
      ...
      <section className="py-14 bg-gradient-to-br from-primary to-primary-dark text-white">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[['500+','Graduates'],['78%','Employed / Freelancing'],['8','Countries Represented'],['5','Graduating Classes']].map(([v,l]) => (
              <div key={l}>
